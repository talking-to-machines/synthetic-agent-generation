...
def main(request):
    ...
    for i in tqdm(range(0, len(data), batch_size)):
        ...
        prompts = generate_candor_prompts(
            batch_data,
            request["demographic_questions"],
            request["survey_questions"],
            include_backstory=True,  # True if backstory should be included
        ...
        batch_file_dir = create_batch_file(
            ...
            batch_file_name="batch_input_llm_replication.jsonl",
        )

        # batch_file_dir = create_batch_file_with_image(
        #     prompts,
        #     system_message_field="system_message",
        #     user_message_field="question_prompt",
        #     batch_file_name="batch_input_llm_replication.jsonl",
...
if __name__ == "__main__":
    ### Configuration for Afrobarometer (START) ###
    # version = "afrobarometer_replication_backstory+cotreasoning_v2"
