...
def main(request):
    ...
    if request["study"] in ["campos", "milkman_control", "milkman_baseline"]:
        data_with_responses["user_response"] = data_with_responses[request["question"]]

    elif request["study"] in ["duch_2023", "duch_2025"]:
...
if __name__ == "__main__":
    study = (
        "duch_2023"  # duch_2023, duch_2025, milkman_baseline, milkman_control, campos
    )
    ...
    if study == "duch_2023":
        ...
        version = "vaccine_financial_incentive_vaccinationstatus_gpt4o_s1"  # Vaccination Outcome
        with_intention = True
        ...
        version = "campos_mercade_et_al_2021_monetary_incentives_gpt4o_s1"
        current_dir = os.path.dirname(__file__)
        experiment_round = "round9"
        ...
        ### Configuration for Milkman et al RCT (START) ###
        version = "milkman_et_al_2024_metastudy_baseline_freeride_gpt4o_s1"  # Baseline + Free Ride
        current_dir = os.path.dirname(__file__)
        experiment_round = "round9"
        scenario = "S1 (Instruct Model)"  # S1 (Instruct Model)
        model = "GPT 4o"  # GPT 4o
