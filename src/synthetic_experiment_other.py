...
if __name__ == "__main__":
    ...
    # version = "vaccine_financial_incentive_vaccinationstatus_deepseek_llama3.3_70b_s3"  # Vaccination Outcome
    # current_dir = os.path.dirname(__file__)
    # experiment_round = "round9"
    # scenario = "S3 (LMIC Survey + RCT)"  # S1 (Instruct Model), S2 (Instruction-Tuned Model), Chain Of Thought, S3 (LMIC Survey + RCT), S4 (LMIC Pilot), S5 (LMIC Survey + RCT + Pilot), S6 (), S7 (), S8 (), S9 (), S10 (), S11 ()
    # model = "DeepSeek R1 Distilled Llama 3.3 70B"  # Llama 3.1 8B, Mistral 7B, Mistral 24B, Llama 3.1 70B, Llama 3.3 70B, Claude 3.5 Sonnet, Gemini 1.5 Pro, DeepSeek R1, DeepSeek R1 Distilled Llama 3.3 70B, Deepseek R1 Distilled Qwen 14B
    ...
    # # )
    # api_url = "https://mm77l0y6j801lfc9.us-east-1.aws.endpoints.huggingface.cloud/v1/"  # HF dedicated inference endpoint
    ...
    version = "duch_et_al_2025_ghana_tubercolosis_screening_mistral_7b_s1"
    current_dir = os.path.dirname(__file__)
    experiment_round = "round9"
    scenario = "S1 (Instruct Model)"  # S1 (Instruct Model), S2 (Instruction-Tuned Model), Chain Of Thought, S3 (LMIC Survey + RCT), S4 (LMIC Pilot), S5 (LMIC Survey + RCT + Pilot), S6 (), S7 (), S8 (), S9 (), S10 (), S11 ()
    model = "Mistral 7B"  # Llama 3.1 8B, Mistral 7B, Llama 3.1 70B, Claude 3.5 Sonnet, Gemini 1.5 Pro, Grok 2, DeepSeek R1, DeepSeek R1 Distilled Llama 3.3 70B, Deepseek R1 Distilled Qwen 14B
    data_file_path = os.path.join(
        current_dir,
